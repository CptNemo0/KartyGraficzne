...
const std::string kWindowTitle = "Karty Graficzne";

const std::string kVertexShaderPath = "BasicVertexShader.vert";
const std::string kFragmentShaderPath = "BasicFragmentShader.frag";

const std::string kGreenTexturePath = "green_texture.png";
const std::string kRedTexturePath = "red_texture.png";

const std::string kCubeMeshPath = "cube.obj";
